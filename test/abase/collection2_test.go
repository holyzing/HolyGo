...
type TestChangeMapValueStruct struct {
	A string
	B int
}

func TestChangeMapValue(t *testing.T) {
	m := map[string]*TestChangeMapValueStruct{
		"A": &TestChangeMapValueStruct{A: "A", B: 12},
		"B": &TestChangeMapValueStruct{A: "A2", B: 13},
	}
	...
	m2 := map[string]TestChangeMapValueStruct{
		"A": TestChangeMapValueStruct{A: "A", B: 12},
		"B": TestChangeMapValueStruct{A: "A2", B: 13},
	}
	println(m2["A"].A)
