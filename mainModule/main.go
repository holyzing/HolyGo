...
import (
	...
	// "./collects"
	// local import "./collects" in non-local packagego

	// "./collects"
	// cannot find module for path _/home/holyzing/xtalpi/My/_06_Golang/mainModule/collects
	// 顶层目录存在 go.module

	// "collects"
	// package collects is not in GOROOT
